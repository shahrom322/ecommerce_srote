...
4. Пользователь заполняет данные для отправки заказа, вводит имеющийся промокод.
5. Подтверждает оплату.
6. Заказ отслеживается до момента доставки. Пользователь может оформить возврат.
"""
